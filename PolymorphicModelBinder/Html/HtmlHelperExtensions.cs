...
namespace PolymorphicModelBinder.Html
{
    public static class HtmlHelperExtensions
    {
        ...
        public static IHtmlContent PolymorphicTypeInValue(this IHtmlHelper htmlHelper)
        {
            ...
            return htmlHelper
                .Hidden(TypeInValuePolymorphicBindable.FieldName, htmlHelper.ViewData.Model.GetType().AssemblyQualifiedName);
        }
            ...
            Expression<Func<T, TProp>> expression)
        {
            ...
            return htmlHelper
                .Hidden($"{mvcHtmlString}.{TypeInValuePolymorphicBindable.FieldName}", model.GetType().AssemblyQualifiedName);
        }
    }
}