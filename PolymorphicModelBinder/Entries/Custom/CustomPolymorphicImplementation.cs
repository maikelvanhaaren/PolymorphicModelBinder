...
public class CustomPolymorphicImplementation : IPolymorphicImplementation
{
    private readonly Func<ModelBindingContext, bool> _isMatchFunc;

    public CustomPolymorphicImplementation(Type type, Func<ModelBindingContext, bool> isMatchFunc)
    {
        BindToType = type;
